    ...
    public void symuluj() {
        ...
        for (pozycjaGrupy = 0; pozycjaGrupy < wycieczka.getLiczbaElementowWycieczki(); pozycjaGrupy++) {
            ...
            if (elementWycieczki instanceof Atrakcja) {
                ...
                double czas = atrakcja.getCzasZwiedzaniaH();
                for (Uczestnik u : grupa.getUczestnicy()) {
            ...
            else if (elementWycieczki instanceof Wedrowka) {
                ...
                int brakiNawigacyjne = wedrowka.getTrudnoscNawigacyjna()
                        - grupa.getPrzewodnik().getUmiejetnosciNawigacyjne();
