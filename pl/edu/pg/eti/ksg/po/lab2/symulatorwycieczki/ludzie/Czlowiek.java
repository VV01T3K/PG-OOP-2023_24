...
public abstract class Czlowiek implements Uczestnik {
    ...
    public Czlowiek(String imie, String nazwisko, Plec plec, double maksymalnaPredkosc, double czasPelnejRegeneracji,
            double czasPelnegoZmeczenia) {
        this.imie = imie;
    ...
    protected void regeneruj(double czas) {
        ...
        System.out.println("Poziom zmęczenia u " + imie + " " + nazwisko + " zmalał o " + zregenerowano + " i wynosi "
                + poziomZmeczenia + ".");
    }
    ...
    protected void aktualizujZmeczenie(double czas) {
        ...
        System.out.println("Poziom zmęczenia u " + imie + " " + nazwisko + " wzrósł o " + dodatkoweZmeczenie
                + " i wynosi " + poziomZmeczenia + ".");
